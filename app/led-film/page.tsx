...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Next-generation transparent LED display that mounts directly onto glass surfaces.",
    // REPLACE: OG image for LED Film page
    images: ["https://placehold.co/1200x630/111827/ffffff?text=LED+Film+Screen"],
  },
};
...
const FEATURES = [
  {
    ...
    image: "https://placehold.co/700x500/111827/ffffff?text=LED+Film+Close-Up",
  ...
  },
  {
    ...
    image: "https://placehold.co/700x500/111827/ffffff?text=Film+vs+Traditional+LED",
  ...
  },
  {
    ...
    image: "https://placehold.co/700x500/111827/ffffff?text=LED+Film+Retail+Installation",
  ...
  },
  {
    ...
    image: "https://placehold.co/700x500/111827/ffffff?text=Daylight+Visibility",
  ...
  },
  {
    ...
    image: "https://placehold.co/700x500/111827/ffffff?text=LED+Film+Installation",
    ...
    <PageTransition>
      ...
      <section className="relative min-h-[80vh] flex items-end overflow-hidden">
        <div className="absolute inset-0">
          ...
          <Image
            src="https://placehold.co/1400x700/080c14/111827?text=LED+Film+Screen+Hero+%E2%80%94+Glass+Storefront+with+LED+Overlay"
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-8 pt-40 pb-20 w-full">
          <SectionTag className="mb-6">LED Film Screen</SectionTag>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-24">
        {FEATURES.map((feature, i) => (
          ...
          >
            <div className={`grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center ${i % 2 === 1 ? "" : ""}`}>
      ...
      {/* ── FAQ ── */}
      <section className="py-24 bg-brand-navy border-y border-brand-border">
      ...
      <section className="py-24 lg:py-32">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          <h2 className="text-4xl sm:text-5xl font-black text-white leading-tight tracking-tight mb-6">
            Ready to see what LED Film<br />
            can do for your space?
          </h2>
          <p className="text-gray-400 text-lg mb-10">Book a showroom visit.</p>
          <Link
            href="/contact"
